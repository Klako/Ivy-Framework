...
test.describe("Number Input Tests", () => {
  ...
  test.describe("Slider Number Input Variants", () => {
    test("should test nullable slider interactions", async ({ page }) => {
      const nullableSlider = page.getByTestId("number-input-nullable-slider-main");
      ...
      await expect(nullableSlider).toHaveAttribute("data-orientation", "horizontal");
    });
    ...
    test("should test disabled slider", async ({ page }) => {
      const disabledSlider = page.getByTestId("number-input-int-disabled-slider-main");
    ...
    test("should test invalid slider interactions", async ({ page }) => {
      const invalidSlider = page.getByTestId("number-input-int-invalid-slider-main");
      ...
      // Test that it has the correct data attributes for a slider
      await expect(invalidSlider).toHaveAttribute("data-orientation", "horizontal");
    });
  });
});
