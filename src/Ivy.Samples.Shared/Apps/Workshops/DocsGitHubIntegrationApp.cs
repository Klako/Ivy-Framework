...
[App(icon: Icons.Book, group: ["Workshops"], isVisible: false, title: "Docs GitHub Integration", searchHints: ["documentation", "github", "integration", "workshop", "requirements", "design"])]
