...
const EmbedWidget: React.FC<EmbedWidgetProps> = ({ url }) => {
  ...
  if (platform === "youtube") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="YouTube" />}>
  ...
  if (platform === "facebook") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="Facebook" />}>
  ...
  if (platform === "instagram") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="Instagram" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
  ...
  if (platform === "tiktok") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="TikTok" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
          <TikTokEmbed url={url} />
        </Suspense>
      </EmbedErrorBoundary>
  ...
  if (platform === "twitter") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="Twitter" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
  ...
  if (platform === "linkedin") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="LinkedIn" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
  ...
  if (platform === "pinterest") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="Pinterest" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
  ...
  if (platform === "github") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="GitHub" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
          <GitHubEmbed url={url} />
        </Suspense>
      </EmbedErrorBoundary>
  ...
  if (platform === "reddit") {
    return (
      <EmbedErrorBoundary fallback={<EmbedErrorFallback url={url} platform="Reddit" />}>
        <Suspense fallback={<EmbedLoadingFallback />}>
          <RedditEmbed url={url} />
        </Suspense>
      </EmbedErrorBoundary>
