...
> **tip:** Like `NumberInput`, if you don't explicitly specify `Min` and `Max` for a `NumberRangeInput`, common default values will be applied based on the numeric type. Always set `Min` and `Max` to define your desired range bounds.
...
[View Source: NumberRangeInput.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Inputs/NumberRangeInput.cs)

### Constructors

| Signature |
|-----------|
| `new NumberRangeInput<TNumber>(IAnyState state, bool disabled = false, NumberFormatStyle formatStyle = NumberFormatStyle.Decimal)` |
| `new NumberRangeInput<TNumber>(ValueTuple<TNumber, TNumber> value, Func<Event<IInput<ValueTuple<TNumber, TNumber>>, ValueTuple<TNumber, TNumber>>, ValueTask> onChange, bool disabled = false, NumberFormatStyle formatStyle = NumberFormatStyle.Decimal)` |
| `new NumberRangeInput<TNumber>(ValueTuple<TNumber, TNumber> value, Action<ValueTuple<TNumber, TNumber>> state, bool disabled = false, NumberFormatStyle formatStyle = NumberFormatStyle.Decimal)` |
| `new NumberRangeInput<TNumber>(bool disabled = false, NumberFormatStyle formatStyle = NumberFormatStyle.Decimal)` |
| `ToNumberRangeInput(IAnyState state, bool disabled = false, NumberFormatStyle formatStyle = NumberFormatStyle.Decimal, double? min = null, double? max = null)` |
| `ToMoneyRangeInput(IAnyState state, bool disabled = false, string currency = "USD")` |
...
| Group | Type | Nullable |
|-------|------|----------|
| Other | `ValueTuple<short, short>` | - |
| Other | `ValueTuple<short?, short?>` | - |
| Other | `ValueTuple<int, int>` | - |
| Other | `ValueTuple<int?, int?>` | - |
| Other | `ValueTuple<long, long>` | - |
| Other | `ValueTuple<long?, long?>` | - |
| Other | `ValueTuple<float, float>` | - |
| Other | `ValueTuple<float?, float?>` | - |
| Other | `ValueTuple<double, double>` | - |
| Other | `ValueTuple<double?, double?>` | - |
| Other | `ValueTuple<decimal, decimal>` | - |
| Other | `ValueTuple<decimal?, decimal?>` | - |
| Other | `ValueTuple<byte, byte>` | - |
| Other | `ValueTuple<byte?, byte?>` | - |
...
| `TargetType` | `string` | - |
| `UpperValue` | `TNumber` | - |
| `Value` | `ValueTuple<TNumber, TNumber>` | - |
| `Visible` | `bool` | - |
| `Width` | `Size` | - |
...
| `OnChange` | `EventHandler<Event<IInput<ValueTuple<TNumber, TNumber>>, ValueTuple<TNumber, TNumber>>>` | - |
