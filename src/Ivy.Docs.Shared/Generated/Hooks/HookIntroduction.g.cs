...
[App(order:1, documentSource:"https://github.com/Ivy-Interactive/Ivy-Framework/blob/2587-rename-appattribute-path-parameter-to-group/src/Ivy.Docs.Shared/Docs/03_Hooks/01_HookIntroduction.md", searchHints: ["hooks", "useState", "useEffect", "useQuery", "state-management", "lifecycle", "reactivity", "functional-components"])]
public class HookIntroductionApp(bool onlyBody = false) : ViewBase
{
    public HookIntroductionApp() : this(false)
    {
    }
    public override object? Build()
    {
        ...
        var article = new Article().ShowToc(!onlyBody).ShowFooter(!onlyBody).Previous(appDescriptor.Previous).Next(appDescriptor.Next).DocumentSource(appDescriptor.DocumentSource).OnLinkClick(onLinkClick).Headings(new List<ArticleHeading> { new ArticleHeading("hooks", "Hooks", 1), new ArticleHeading("basic-usage", "Basic usage", 2), new ArticleHeading("hook-library", "Hook Library", 3), new ArticleHeading("core-hooks", "Core Hooks", 2), new ArticleHeading("usestate", "UseState", 3), new ArticleHeading("useeffect", "UseEffect", 3), new ArticleHeading("usereducer", "UseReducer", 3), new ArticleHeading("performance-hooks", "Performance Hooks", 2), new ArticleHeading("usememo", "UseMemo", 3), new ArticleHeading("usecallback", "UseCallback", 3), new ArticleHeading("references--context", "References & Context", 2), new ArticleHeading("useref", "UseRef", 3), new ArticleHeading("usecontext", "UseContext", 3), new ArticleHeading("useargs", "UseArgs", 3), new ArticleHeading("data-fetching", "Data Fetching", 2), new ArticleHeading("usequery", "UseQuery", 3), new ArticleHeading("usemutation", "UseMutation", 3), new ArticleHeading("usesignal", "UseSignal", 3), new ArticleHeading("services--dependencies", "Services & Dependencies", 2), new ArticleHeading("useservice", "UseService", 3), new ArticleHeading("userefreshtoken", "UseRefreshToken", 3), new ArticleHeading("usewebhook", "UseWebhook", 3), new ArticleHeading("ui--interaction", "UI & Interaction", 2), new ArticleHeading("usenavigation", "UseNavigation", 3), new ArticleHeading("usealert", "UseAlert", 3), new ArticleHeading("useblades", "UseBlades", 3), new ArticleHeading("usetrigger", "UseTrigger", 3), new ArticleHeading("useform", "UseForm", 3), new ArticleHeading("useupload", "UseUpload", 3), new ArticleHeading("usedownload", "UseDownload", 3), new ArticleHeading("creating-custom-hooks", "Creating Custom Hooks", 2), new ArticleHeading("see-also", "See Also", 2), })
            | new global::Ivy.Docs.Shared.Internal.SmartSearchView()
            | new Markdown("# Hooks").OnLinkClick(onLinkClick)
            | Lead(
                """"
                Discover the powerful functions that let you "hook into" Ivy state and lifecycle features - Hooks enable you to use state and side effects in your [views](app://onboarding/concepts/views) without writing class components.
                """")
            | new Markdown(
                """"
                ## Basic usage
            ...
            | Tabs( 
                new Tab("Demo", new Box().Content(new HooksDemo())),
            ...
            | new Markdown(
                ...
                | Category                     | Hooks                                                                                                                                     |
                | ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
                | **Core**                     | [UseState](app://hooks/core/use-state), [UseEffect](app://hooks/core/use-effect), [UseReducer](app://hooks/core/use-reducer)                            |
                | **Performance**              | [UseMemo](app://hooks/core/use-memo), [UseCallback](app://hooks/core/use-callback)                                                                 |
                | **References & Context**     | [UseRef](app://hooks/core/use-ref), [UseContext](app://hooks/core/use-context), [UseArgs](app://hooks/core/use-args)                                     |
                | **Data Fetching**            | [UseQuery](app://hooks/core/use-query), [UseMutation](app://hooks/core/use-mutation), [UseSignal](app://hooks/core/use-signal)                           |
                | **Services & Dependencies**  | [UseService](app://hooks/core/use-service), [UseRefreshToken](app://hooks/core/use-refresh-token), [UseWebhook](app://hooks/core/use-webhook)            |
                | **UI & Interaction**         | [UseNavigation](app://onboarding/concepts/navigation), [UseAlert](app://onboarding/concepts/alerts), [UseBlades](app://widgets/common/blades), [UseTrigger](app://hooks/core/use-trigger)  |
                | **Forms**                    | [UseForm](app://onboarding/concepts/forms)                                                                                                             |
                | **Files**                    | [UseUpload](app://widgets/inputs/file-input), [UseDownload](app://hooks/core/use-download)                                                              |
            ...
            | new Markdown(
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new StateDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseState](app://hooks/core/use-state) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new EffectDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseEffect](app://hooks/core/use-effect) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new BasicReducerDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseReducer](app://hooks/core/use-reducer) for detailed documentation.
            ...
            | new Markdown(
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new MemoDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseMemo](app://hooks/core/use-memo) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new CallbackDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseCallback](app://hooks/core/use-callback) for detailed documentation.
            ...
            | new Markdown(
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new RefDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseRef](app://hooks/core/use-ref) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new ContextProvider())
            )
            | new Markdown(
                """"
                See [UseContext](app://hooks/core/use-context) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new UserProfileView())
            )
            | new Markdown(
                """"
                See [UseArgs](app://hooks/core/use-args) for detailed documentation.
            ...
            | new Markdown(
                """"
                See [UseQuery](app://hooks/core/use-query) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new MutationDemo())
            )
            | new Markdown(
                """"
                See [UseMutation](app://hooks/core/use-mutation) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new OneToManyDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseSignal](app://hooks/core/use-signal) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new ServiceDemo())
            )
            | new Markdown(
                """"
                See [UseService](app://hooks/core/use-service) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new RefreshTokenDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseRefreshToken](app://hooks/core/use-refresh-token) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new WebhookDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseWebhook](app://hooks/core/use-webhook) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new NavigationDemo())
            )
            | new Markdown(
                """"
                See [Navigation](app://onboarding/concepts/navigation) for detailed documentation.
            ...
            | (Vertical() 
                | new CodeBlock(
                    ...
                    """",Languages.Csharp)
                | new Box().Content(new AlertDemo())
            )
            | new Markdown(
                """"
                See [Alerts](app://onboarding/concepts/alerts) for detailed documentation.
            ...
            | new Markdown(
                """"
                See [Blades](app://widgets/common/blades) for detailed documentation.
            ...
            | new Markdown(
                """"
                See [UseTrigger](app://hooks/core/use-trigger) for detailed documentation.
            ...
            | new Markdown(
                """"
                See [Forms](app://onboarding/concepts/forms) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new UploadDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [FileInput](app://widgets/inputs/file-input) for detailed documentation.
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new DownloadDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                """"
                See [UseDownload](app://hooks/core/use-download) for detailed documentation.
            ...
            | new Markdown(
                ...
                - [Rules of Hooks](app://hooks/rules-of-hooks) - Essential rules for using hooks correctly
                - [Views](app://onboarding/concepts/views) - Understanding Ivy views
                - [Forms](app://onboarding/concepts/forms) - Working with forms in Ivy
                - [Layout](app://onboarding/concepts/layout) - Structuring UI with layouts
                - [UseService](app://hooks/core/use-service) - Dependency injection and services
                """").OnLinkClick(onLinkClick)
            ;
        // Build errors here indicates that one or more referenced apps don't exist. Check markdown links.
        Type[] _ = [typeof(Onboarding.Concepts.ViewsApp), typeof(Hooks.Core.UseStateApp), typeof(Hooks.Core.UseEffectApp), typeof(Hooks.Core.UseReducerApp), typeof(Hooks.Core.UseMemoApp), typeof(Hooks.Core.UseCallbackApp), typeof(Hooks.Core.UseRefApp), typeof(Hooks.Core.UseContextApp), typeof(Hooks.Core.UseArgsApp), typeof(Hooks.Core.UseQueryApp), typeof(Hooks.Core.UseMutationApp), typeof(Hooks.Core.UseSignalApp), typeof(Hooks.Core.UseServiceApp), typeof(Hooks.Core.UseRefreshTokenApp), typeof(Hooks.Core.UseWebhookApp), typeof(Onboarding.Concepts.NavigationApp), typeof(Onboarding.Concepts.AlertsApp), typeof(Widgets.Common.BladesApp), typeof(Hooks.Core.UseTriggerApp), typeof(Onboarding.Concepts.FormsApp), typeof(Widgets.Inputs.FileInputApp), typeof(Hooks.Core.UseDownloadApp), typeof(Hooks.RulesOfHooksApp), typeof(Onboarding.Concepts.LayoutApp)]; 
        return article;
    }
}
