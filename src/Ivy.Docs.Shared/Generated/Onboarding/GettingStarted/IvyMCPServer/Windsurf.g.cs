...
[App(order:6, documentSource:"https://github.com/Ivy-Interactive/Ivy-Framework/blob/2587-rename-appattribute-path-parameter-to-group/src/Ivy.Docs.Shared/Docs/01_Onboarding/01_GettingStarted/07_IvyMCPServer/06_Windsurf.md")]
public class WindsurfApp(bool onlyBody = false) : ViewBase
{
    public WindsurfApp() : this(false)
    {
    }
