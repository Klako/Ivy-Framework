...
For information about core Ivy concepts like [Views](../02_Concepts/02_Views.md) and [state management](../../03_Hooks/02_Core/03_UseState.md), see [Core Concepts](../02_Concepts/02_Views.md). For guidance on building your first application, see [Basics](./03_Basics.md). For development tools and CLI commands, see [CLI Tools](../03_CLI/01_CLIOverview.md). For Ivy’s goals and architecture, see [How Ivy works — Core philosophy](./04_HowIvyWorks.md#core-philosophy).
