...
These values will be combined into a connection string and stored in [.NET user secrets](../../02_Concepts/14_Secrets.md):
...
![Airtable create personal access token page](/ivy/ivy-assets/airtable_create_pat.webp "Airtable create personal access token page")
...
![Airtable API Reference](/ivy/ivy-assets/airtable_api_reference.webp "Airtable API Reference")
...
![Airtable Base-Specific API Reference, showing the chosen base's ID](/ivy/ivy-assets/airtable_base_id.webp "Airtable Base-Specific API Reference")
