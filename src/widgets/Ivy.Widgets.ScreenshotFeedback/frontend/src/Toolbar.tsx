      ...
      return (
        <svg {...props}>
          ...
          <text
            ...
            fill={props.stroke === "currentColor" ? "#0a1a0f" : "#fff"}
            fontSize="9"
            fontWeight="bold"
            stroke="none"
          >
          ...
          <line x1="20" y1="18" x2="20" y2="23" stroke="none" />
        </svg>
      );
    case DrawingTool.Freehand:
      return (
        <svg {...props}>
          <path d="M3 17c1.5-3 3-5 5-5s3 2 5 2 3.5-2 5-5" />
          <path d="M20 5l-2 2" />
        </svg>
      );
  ...
  return (
    <div className="screenshot-toolbar">
      ...
      <div className="screenshot-toolbar-group">
        ...
        <button className="save-btn" onClick={onSave} disabled={submitting}>
          {submitting ? (
            <>
              <svg
                className="screenshot-spinner"
                width={14}
                height={14}
                viewBox="0 0 24 24"
                fill="none"
