...
| Signature |
|-----------|
| `new BoolInput(IAnyState state, string label = null, bool disabled = false, BoolInputVariant variant = BoolInputVariant.Checkbox)` |
| `new BoolInput(bool value, Func<Event<IInput<bool>, bool>, ValueTask> onChange, string label = null, bool disabled = false, BoolInputVariant variant = BoolInputVariant.Checkbox)` |
| `new BoolInput(bool value, Action<Event<IInput<bool>, bool>> onChange, string label = null, bool disabled = false, BoolInputVariant variant = BoolInputVariant.Checkbox)` |
| `new BoolInput(string label = null, bool disabled = false, BoolInputVariant variant = BoolInputVariant.Checkbox)` |
| `ToBoolInput(IAnyState state, string label = null, bool disabled = false, BoolInputVariant variant = BoolInputVariant.Checkbox)` |
...
| `Placeholder` | `string` | - |
| `Value` | `bool` | - |
| `Variant` | `BoolInputVariant` | `Variant` |
| `Visible` | `bool` | - |
| `Width` | `Size` | - |
