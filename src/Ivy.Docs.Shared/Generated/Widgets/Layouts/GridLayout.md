...
[View Source: GridLayout.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Layouts/GridLayout.cs)

### Constructors

| Signature |
|-----------|
| `new GridLayout(GridDefinition def, Object[] children)` |
...
| `ChildColumn` | `Nullable`1[]` | - |
| `ChildColumnSpan` | `Nullable`1[]` | - |
| `ChildRow` | `Nullable`1[]` | - |
| `ChildRowSpan` | `Nullable`1[]` | - |
| `ColumnGap` | `int` | - |
| `Columns` | `int?` | - |
| `ColumnWidths` | `Size[]` | - |
| `Density` | `Density?` | - |
