...
test.describe("DateTime Input Tests", () => {
  ...
  test.describe("Date Input Variants", () => {
    ...
    test("should test nullable invalid date input", async ({ page }) => {
      const nullableInvalidInput = page.getByTestId("datetime-input-date-nullable-invalid-main");
      await expect(nullableInvalidInput).toBeVisible();

      // Test that the date input is a button (date picker)
      await expect(nullableInvalidInput).toHaveAttribute("type", "button");
      await expect(nullableInvalidInput).toHaveAttribute("aria-haspopup", "dialog");
    });
  });
  ...
  test.describe("DateTime Input Variants", () => {
    ...
    test("should test disabled datetime input", async ({ page }) => {
      const disabledInput = page.getByTestId("datetime-input-datetime-disabled-main");
      await expect(disabledInput).toBeVisible();
    ...
    test("should test invalid datetime input", async ({ page }) => {
      const invalidInput = page.getByTestId("datetime-input-datetime-invalid-main");
      await expect(invalidInput).toBeVisible();
    ...
    test("should test nullable datetime input", async ({ page }) => {
      const nullableInput = page.getByTestId("datetime-input-datetime-nullable-main");
      await expect(nullableInput).toBeVisible();
  ...
  test.describe("Time Input Variants", () => {
    test("should test time input interactions", async ({ page }) => {
      ...
      await expect(timeInput).toHaveAttribute("class", /relative flex items-center/);
    });

    test("should test disabled time input", async ({ page }) => {
      const disabledInput = page.getByTestId("datetime-input-time-disabled-main");
      await expect(disabledInput).toBeVisible();

      // Test that the time input is a div container
      await expect(disabledInput).toHaveAttribute("class", /relative flex items-center/);
    });
    ...
    test("should test invalid time input", async ({ page }) => {
      ...
      // Test that the time input is a div container
      await expect(invalidInput).toHaveAttribute("class", /relative flex items-center/);
    });

    test("should test nullable time input", async ({ page }) => {
      const nullableInput = page.getByTestId("datetime-input-time-nullable-main");
      await expect(nullableInput).toBeVisible();

      // Test that the time input is a div container
      await expect(nullableInput).toHaveAttribute("class", /relative flex items-center/);
    });

    test("should test nullable invalid time input", async ({ page }) => {
      const nullableInvalidInput = page.getByTestId("datetime-input-time-nullable-invalid-main");
      await expect(nullableInvalidInput).toBeVisible();

      // Test that the time input is a div container
      await expect(nullableInvalidInput).toHaveAttribute("class", /relative flex items-center/);
    });
  });
  ...
  test.describe("Placeholder Examples", () => {
    test("should test placeholder examples", async ({ page }) => {
      ...
      const birthdayInput = page.getByTestId("datetime-input-placeholder-birthday");
      ...
      const startDateInput = page.getByTestId("datetime-input-placeholder-start-date");
      await expect(startDateInput).toBeVisible();

      const deadlineInput = page.getByTestId("datetime-input-placeholder-deadline");
      await expect(deadlineInput).toBeVisible();

      const startTimeInput = page.getByTestId("datetime-input-placeholder-start-time");
      await expect(startTimeInput).toBeVisible();

      const lunchTimeInput = page.getByTestId("datetime-input-placeholder-lunch-time");
