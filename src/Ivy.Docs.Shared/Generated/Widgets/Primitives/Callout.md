...
[View Source: Callout.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Primitives/Callout.cs)

### Constructors

| Signature |
|-----------|
| `new Callout(object description = null, string title = null, CalloutVariant variant = CalloutVariant.Info, Icons? icon = null)` |
...
| Name | Type | Handlers |
|------|------|----------|
| `OnClose` | `EventHandler<Event<Callout>>` | `OnClose` |
