...
| Signature |
|-----------|
| `new ColorInput(IAnyState state, string placeholder = null, bool disabled = false, ColorInputVariant variant = ColorInputVariant.TextAndPicker)` |
| `new ColorInput(string value, Func<Event<IInput<string>, string>, ValueTask> onChange, string placeholder = null, bool disabled = false, ColorInputVariant variant = ColorInputVariant.TextAndPicker)` |
| `new ColorInput(string value, Action<Event<IInput<string>, string>> onChange, string placeholder = null, bool disabled = false, ColorInputVariant variant = ColorInputVariant.TextAndPicker)` |
| `new ColorInput(string placeholder = null, bool disabled = false, ColorInputVariant variant = ColorInputVariant.TextAndPicker)` |
| `ToColorInput(IAnyState state, string placeholder = null, bool disabled = false, ColorInputVariant? variant = null)` |
...
| `Value` | `string` | - |
| `Variant` | `ColorInputVariant` | `Variant` |
| `Visible` | `bool` | - |
| `Width` | `Size` | - |
