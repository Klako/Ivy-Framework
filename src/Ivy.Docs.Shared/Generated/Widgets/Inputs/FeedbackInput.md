...
| Signature |
|-----------|
| `new FeedbackInput<TNumber>(IAnyState state, string placeholder = null, bool disabled = false, FeedbackInputVariant variant = FeedbackInputVariant.Stars)` |
| `new FeedbackInput<TNumber>(TNumber value, Func<Event<IInput<TNumber>, TNumber>, ValueTask> onChange, string placeholder = null, bool disabled = false, FeedbackInputVariant variant = FeedbackInputVariant.Stars)` |
| `new FeedbackInput<TNumber>(TNumber value, Action<TNumber> state, string placeholder = null, bool disabled = false, FeedbackInputVariant variant = FeedbackInputVariant.Stars)` |
| `new FeedbackInput<TNumber>(string placeholder = null, bool disabled = false, FeedbackInputVariant variant = FeedbackInputVariant.Stars)` |
| `ToFeedbackInput(IAnyState state, string placeholder = null, bool disabled = false, FeedbackInputVariant? variant = null)` |
...
| `Value` | `TNumber` | - |
| `Variant` | `FeedbackInputVariant` | `Variant` |
| `Visible` | `bool` | - |
| `Width` | `Size` | - |
