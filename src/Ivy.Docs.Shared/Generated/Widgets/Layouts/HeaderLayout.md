...
> **tip:** For [widgets](../../01_Onboarding/02_Concepts/03_Widgets.md) that handle their own scrolling (like Kanban boards), use `.Scroll(Scroll.None)` to disable the HeaderLayout's ScrollArea wrapper. Height is automatically set to [Size.Full()](../../04_ApiReference/Ivy/Size.md) when scroll is disabled.
...
[View Source: HeaderLayout.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Layouts/HeaderLayout.cs)

### Constructors

| Signature |
|-----------|
| `new HeaderLayout(object header, object content)` |
