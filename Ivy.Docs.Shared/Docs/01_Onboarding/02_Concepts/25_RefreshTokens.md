...
The `UseRefreshToken` hook creates a token that can be manually refreshed to trigger [effects](./09_Effects.md):
...
- [Effects](./09_Effects.md) - Learn about the UseEffect hook
