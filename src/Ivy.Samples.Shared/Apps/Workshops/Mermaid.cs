...
[App(icon: Icons.Workflow, group: ["Workshops"], isVisible: false, title: "Mermaid Workshop", searchHints: ["diagrams", "mermaid", "flowchart", "workshop", "requirements", "visualization"])]
