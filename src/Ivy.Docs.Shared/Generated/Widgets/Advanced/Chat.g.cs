...
[App(order:4, documentSource:"https://github.com/Ivy-Interactive/Ivy-Framework/blob/2587-rename-appattribute-path-parameter-to-group/src/Ivy.Docs.Shared/Docs/02_Widgets/07_Advanced/04_Chat.md", searchHints: ["messaging", "conversation", "chat", "messages", "communication", "agent", "ai"])]
public class ChatApp(bool onlyBody = false) : ViewBase
{
    public ChatApp() : this(false)
    {
    }
    public override object? Build()
    {
        ...
        var article = new Article().ShowToc(!onlyBody).ShowFooter(!onlyBody).Previous(appDescriptor.Previous).Next(appDescriptor.Next).DocumentSource(appDescriptor.DocumentSource).OnLinkClick(onLinkClick).Headings(new List<ArticleHeading> { new ArticleHeading("chat", "Chat", 1), new ArticleHeading("basic-chat", "Basic Chat", 2), new ArticleHeading("ai-assistant-with-loading-states-and-cancel-request", "AI Assistant with Loading States and Cancel Request", 2), new ArticleHeading("interactive-chat-with-streaming-output-and-cancel", "Interactive Chat with Streaming Output and Cancel", 2), new ArticleHeading("interactive-chat-with-rich-content", "Interactive Chat with Rich Content", 2), new ArticleHeading("error-handling-chat", "Error Handling Chat", 2), new ArticleHeading("advanced-chat-with-commands", "Advanced Chat with Commands", 2), new ArticleHeading("api", "API", 2), })
            | new global::Ivy.Docs.Shared.Internal.SmartSearchView()
            | new Markdown(
                """"
                # Chat
                
                The `Chat` [widget](app://onboarding/concepts/widgets) renders a conversation between a user and an assistant. Use it inside [views](app://onboarding/concepts/views) and [layouts](app://onboarding/concepts/layout).
                
                Messages are supplied as `ChatMessage` objects and new messages are sent through the `OnSend` [event](app://onboarding/concepts/event-handlers).
                
                ## Basic Chat
                
                A simple chat with an echo bot that repeats user messages.
                
                This demonstrates the fundamental usage of the Chat widget with basic message handling and [state management](app://hooks/core/use-state).
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new BasicChatDemo())),
            ...
            | new Markdown(
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new LoadingChatDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new StreamingChatDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                ...
                A chat that responds with interactive elements like [buttons](app://widgets/common/button) and [cards](app://widgets/common/card).
                ...
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new InteractiveChatDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                ...
                This example shows how to use the [Error](app://widgets/primitives/error) widget for different message severities and how to integrate ChatStatus for loading indicators within chat conversations.
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new ErrorHandlingChatDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new Markdown(
                ...
                This example showcasing the full range of Ivy [widgets](app://onboarding/concepts/widgets) that can be embedded in chat responses.
                """").OnLinkClick(onLinkClick)
            | Tabs( 
                new Tab("Demo", new Box().Content(new AdvancedChatDemo())),
                new Tab("Code", new CodeBlock(
                    """"
            ...
            | new WidgetDocsView("Ivy.Chat", "Ivy.ChatExtensions", "https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Chat.cs")
            ;
        // Build errors here indicates that one or more referenced apps don't exist. Check markdown links.
        Type[] _ = [typeof(Onboarding.Concepts.WidgetsApp), typeof(Onboarding.Concepts.ViewsApp), typeof(Onboarding.Concepts.LayoutApp), typeof(Onboarding.Concepts.EventHandlersApp), typeof(Hooks.Core.UseStateApp), typeof(Widgets.Common.ButtonApp), typeof(Widgets.Common.CardApp), typeof(Widgets.Primitives.ErrorApp)]; 
        return article;
    }
}
