...
[View Source: Calendar.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Calendar/Calendar.cs)

### Constructors

| Signature |
|-----------|
| `new Calendar(CalendarEvent[] events)` |
...
| `AspectRatio` | `float?` | - |
| `Date` | `DateTime?` | - |
| `DefaultView` | `CalendarDisplayMode` | - |
| `Density` | `Density?` | - |
| `EnableDragDrop` | `bool` | - |
| `Height` | `Size` | - |
| `MaxDate` | `DateTime?` | - |
...
| Name | Type | Handlers |
|------|------|----------|
| `OnEventClick` | `EventHandler<Event<Calendar, object>>` | - |
| `OnEventMove` | `EventHandler<Event<Calendar, ValueTuple<object, DateTime, DateTime>>>` | - |
| `OnEventResize` | `EventHandler<Event<Calendar, ValueTuple<object, DateTime, DateTime>>>` | - |
| `OnSelectSlot` | `EventHandler<Event<Calendar, ValueTuple<DateTime, DateTime>>>` | - |