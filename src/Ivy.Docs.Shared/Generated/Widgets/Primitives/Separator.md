...
The `Separator` [widget](../../01_Onboarding/02_Concepts/03_Widgets.md) creates a visual divider between content sections. It helps organize information and improve readability by clearly demarcating different parts of your interface.
...
[View Source: Separator.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Primitives/Separator.cs)

### Constructors

| Signature |
|-----------|
| `new Separator(string text = null, Orientation orientation = Orientation.Horizontal)` |
