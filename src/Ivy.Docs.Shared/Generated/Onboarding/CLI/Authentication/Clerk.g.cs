...
[App(order:2, documentSource:"https://github.com/Ivy-Interactive/Ivy-Framework/blob/2587-rename-appattribute-path-parameter-to-group/src/Ivy.Docs.Shared/Docs/01_Onboarding/03_CLI/04_Authentication/02_Clerk.md", searchHints: ["clerk", "authentication", "oauth", "social-login", "identity", "auth"])]
public class ClerkApp(bool onlyBody = false) : ViewBase
{
    public ClerkApp() : this(false)
    {
    }
    public override object? Build()
    {
        ...
        var article = new Article().ShowToc(!onlyBody).ShowFooter(!onlyBody).Previous(appDescriptor.Previous).Next(appDescriptor.Next).DocumentSource(appDescriptor.DocumentSource).OnLinkClick(onLinkClick).Headings(new List<ArticleHeading> { new ArticleHeading("clerk-authentication-provider", "Clerk Authentication Provider", 1), new ArticleHeading("overview", "Overview", 2), new ArticleHeading("getting-your-clerk-configuration", "Getting Your Clerk Configuration", 2), new ArticleHeading("step-1-create-a-clerk-account-and-application", "Step 1: Create a Clerk Account and Application", 3), new ArticleHeading("step-2-get-your-api-keys", "Step 2: Get Your API Keys", 3), new ArticleHeading("step-3-configure-allowed-origins", "Step 3: Configure Allowed Origins", 3), new ArticleHeading("step-4-enable-authentication-methods", "Step 4: Enable Authentication Methods", 3), new ArticleHeading("email-and-password", "Email and Password", 4), new ArticleHeading("username-and-password", "Username and Password", 4), new ArticleHeading("social-connections-oauth", "Social Connections (OAuth)", 4), new ArticleHeading("step-5-configure-session-token", "Step 5: Configure Session Token", 3), new ArticleHeading("development-vs-production-modes", "Development vs Production Modes", 3), new ArticleHeading("creating-a-production-instance", "Creating a Production Instance", 4), new ArticleHeading("adding-authentication", "Adding Authentication", 2), new ArticleHeading("advanced-configuration", "Advanced Configuration", 3), new ArticleHeading("connection-strings", "Connection Strings", 4), new ArticleHeading("manual-configuration", "Manual Configuration", 4), new ArticleHeading("configuration-parameters", "Configuration Parameters", 4), new ArticleHeading("authentication-flow", "Authentication Flow", 2), new ArticleHeading("session-based-flow", "Session-based Flow", 3), new ArticleHeading("clerk-specific-features", "Clerk-Specific Features", 2), new ArticleHeading("security-best-practices", "Security Best Practices", 2), new ArticleHeading("troubleshooting", "Troubleshooting", 2), new ArticleHeading("common-issues", "Common Issues", 3), new ArticleHeading("related-documentation", "Related Documentation", 2), })
            | new global::Ivy.Docs.Shared.Internal.SmartSearchView()
            | new Markdown("# Clerk Authentication Provider").OnLinkClick(onLinkClick)
            | Lead("Secure your Ivy application with Clerk's modern authentication platform featuring social logins, passwordless authentication, and advanced security features.")
            | new Markdown(
                """"
                ## Overview
            ...
            | new Markdown(
                ...
                Your credentials will be stored securely in [.NET user secrets](app://onboarding/concepts/secrets).
                
                Ivy then finishes configuring your application automatically:
                
                1. Adds the `Ivy.Auth.Clerk` package to your project
                2. Adds `server.UseAuth<ClerkAuthProvider>()` to your [Program.cs](app://onboarding/concepts/program)
                ...
                """").OnLinkClick(onLinkClick)
            | new Terminal()
                .AddCommand("ivy auth add --provider Clerk --connection-string \"Clerk:PublishableKey=pk_test_xxxxx; Clerk:SecretKey=sk_test_xxxxx;\"")
            ...
            | new Markdown(
                ...
                When deploying an Ivy project without using `ivy deploy`, your local [.NET user secrets](app://onboarding/concepts/secrets) are not automatically transferred. In that case, you can configure Clerk auth by setting environment variables or .NET user secrets. See Configuration Parameters below.
