...
The `Iframe` [widget](../../01_Onboarding/02_Concepts/03_Widgets.md) embeds external web pages into your [app](../../01_Onboarding/02_Concepts/15_Apps.md). It creates a contained browsing context that can display content from other websites while maintaining security boundaries.
...
[View Source: Iframe.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Primitives/Iframe.cs)

### Constructors

| Signature |
|-----------|
| `new Iframe(string src, long? refreshToken = null)` |
...
| Name | Type | Handlers |
|------|------|----------|
| `OnMessageReceived` | `Func<Event<Iframe, ValueTuple<string, JsonNode>>, ValueTask>` | `HandleMessageReceived` |