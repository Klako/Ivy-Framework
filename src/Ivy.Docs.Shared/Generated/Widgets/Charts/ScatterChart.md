...
[View Source: ScatterChart.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Charts/ScatterChart.cs)

### Constructors

| Signature |
|-----------|
| `new ScatterChart(object data, Scatter[] scatters)` |
