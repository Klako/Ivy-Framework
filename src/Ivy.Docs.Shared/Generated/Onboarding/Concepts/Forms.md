...
> **tip:** Use `OnChange` for settings panels where changes should apply immediately. Use `OnBlur` when you want to commit after the user finishes editing each field without a submit button.
...
| Name | Type | Handlers |
|------|------|----------|
| `OnSubmit` | `EventHandler<Event<Form>>` | `OnSubmit` |
