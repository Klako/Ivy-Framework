...
[View Source: PieChart.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Charts/PieChart.cs)

### Constructors

| Signature |
|-----------|
| `new PieChart(object data)` |
