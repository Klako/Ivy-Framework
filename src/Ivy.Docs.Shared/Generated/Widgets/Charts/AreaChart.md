...
[View Source: AreaChart.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Charts/AreaChart.cs)

### Constructors

| Signature |
|-----------|
| `new AreaChart(object data, Area[] areas)` |
