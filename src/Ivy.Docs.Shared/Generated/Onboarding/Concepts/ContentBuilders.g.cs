...
[App(order:7, documentSource:"https://github.com/Ivy-Interactive/Ivy-Framework/blob/2587-rename-appattribute-path-parameter-to-group/src/Ivy.Docs.Shared/Docs/01_Onboarding/02_Concepts/07_ContentBuilders.md", searchHints: ["formatting", "rendering", "transform", "display", "middleware", "custom"])]
public class ContentBuildersApp(bool onlyBody = false) : ViewBase
{
    public ContentBuildersApp() : this(false)
    {
    }
    public override object? Build()
    {
        ...
        var article = new Article().ShowToc(!onlyBody).ShowFooter(!onlyBody).Previous(appDescriptor.Previous).Next(appDescriptor.Next).DocumentSource(appDescriptor.DocumentSource).OnLinkClick(onLinkClick).Headings(new List<ArticleHeading> { new ArticleHeading("content-builders", "Content Builders", 1), new ArticleHeading("overview", "Overview", 2), new ArticleHeading("default-content-builder", "Default Content Builder", 2), new ArticleHeading("custom-content-builders", "Custom Content Builders", 2), new ArticleHeading("using-content-builders", "Using Content Builders", 2), new ArticleHeading("builder-factory", "Builder Factory", 2), new ArticleHeading("best-practices", "Best Practices", 2), new ArticleHeading("examples", "Examples", 2), })
            | new global::Ivy.Docs.Shared.Internal.SmartSearchView()
            | new Markdown("# Content Builders").OnLinkClick(onLinkClick)
            | Lead("Flexible system for transforming and formatting content for display in Ivy.")
            | new Markdown(
                """"
                ## Overview
                ...
                - **Complex Types**:
                  ...
                  - [Tasks](app://onboarding/concepts/tasks-and-observables) > Task views
                  - [Observables](app://onboarding/concepts/tasks-and-observables) > Observable views
                  - JSON nodes > JSON views
                  - XML objects > XML views
                  - Collections > [Tables](app://widgets/common/table)
                  - [Icons](app://widgets/primitives/icon) > Icon views
                  - [Widgets](app://onboarding/concepts/widgets) and [Views](app://onboarding/concepts/views) > Direct rendering
            ...
            | new Markdown(
                ...
                Content Builders are typically used through the Ivy [Program](app://onboarding/concepts/program) and [Server](app://onboarding/concepts/program) configuration:
                """").OnLinkClick(onLinkClick)
            | new CodeBlock(
                """"
                ...
                """",Languages.Csharp)
            | new Markdown("You can also chain multiple content builders using the middleware pattern:").OnLinkClick(onLinkClick)
            | new CodeBlock(
                """"
            ...
            | new Markdown(
                ...
                ## Examples
                """").OnLinkClick(onLinkClick)
            | new Expandable("Different types of content are automatically formatted:",
                Tabs( 
                    new Tab("Demo", new Box().Content(new ContentBuilderDemo())),
        ...
        Type[] _ = [typeof(Onboarding.Concepts.TasksAndObservablesApp), typeof(Widgets.Common.TableApp), typeof(Widgets.Primitives.IconApp), typeof(Onboarding.Concepts.WidgetsApp), typeof(Onboarding.Concepts.ViewsApp), typeof(Onboarding.Concepts.ProgramApp)]; 
        return article;
    }
}
