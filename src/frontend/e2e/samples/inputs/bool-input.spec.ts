...
test.describe("Bool Input Tests", () => {
  ...
  test.describe("Checkbox Variants", () => {
    test.skip("should test checkbox with description interactions", async ({ page }) => {
      ...
      const falseCheckbox = page.getByTestId("checkbox-false-state-width-description");
      ...
      const disabledCheckbox = page.getByTestId("checkbox-true-state-width-description-disabled");
      await expect(disabledCheckbox).toBeVisible();
      await expect(disabledCheckbox).toBeDisabled();

      // Test invalid state with description
      const invalidCheckbox = page.getByTestId("checkbox-true-state-width-description-invalid");
      ...
      const nullCheckbox = page.getByTestId("checkbox-null-state-width-description");
    ...
    test.skip("should test checkbox without description interactions", async ({ page }) => {
      ...
      const disabledCheckbox = page.getByTestId("checkbox-true-state-width-disabled");
      await expect(disabledCheckbox).toBeVisible();
      await expect(disabledCheckbox).toBeDisabled();

      // Test invalid state without description
      const invalidCheckbox = page.getByTestId("checkbox-true-state-width-invalid");
      await expect(invalidCheckbox).toBeVisible();
      await expect(invalidCheckbox).toHaveAttribute("aria-checked", "true");
      await invalidCheckbox.click();
      await expect(invalidCheckbox).toHaveAttribute("aria-checked", "false");
  ...
  test.describe("Switch Variants", () => {
    test("should test switch with description interactions", async ({ page }) => {
      // Test true state with description
      const trueSwitch = page.getByTestId("switch-true-state-width-description");
      ...
      // Test false state with description
      const falseSwitch = page.getByTestId("switch-false-state-width-description");
      ...
      // Test disabled state with description
      const disabledSwitch = page.getByTestId("switch-true-state-width-description-disabled");
      await expect(disabledSwitch).toBeVisible();
      await expect(disabledSwitch).toBeDisabled();

      // Test invalid state with description
      const invalidSwitch = page.getByTestId("switch-true-state-width-description-invalid");
    ...
    test("should test switch without description interactions", async ({ page }) => {
      // Test true state without description
      ...
      // Test disabled state without description
      const disabledSwitch = page.getByTestId("switch-true-state-width-disabled");
      await expect(disabledSwitch).toBeVisible();
      await expect(disabledSwitch).toBeDisabled();
  ...
  test.describe("Toggle Variants", () => {
    test("should test toggle with description interactions", async ({ page }) => {
      // Test true state with description
      const trueToggle = page.getByTestId("toggle-true-state-width-description");
      ...
      // Test false state with description
      const falseToggle = page.getByTestId("toggle-false-state-width-description");
      ...
      // Test disabled state with description
      const disabledToggle = page.getByTestId("toggle-true-state-width-description-disabled");
      await expect(disabledToggle).toBeVisible();
      await expect(disabledToggle).toBeDisabled();

      // Test invalid state with description
      const invalidToggle = page.getByTestId("toggle-true-state-width-description-invalid");
    ...
    test("should test toggle without description interactions", async ({ page }) => {
      // Test true state without description
      ...
      // Test disabled state without description
      const disabledToggle = page.getByTestId("toggle-true-state-width-disabled");
      await expect(disabledToggle).toBeVisible();
      await expect(disabledToggle).toBeDisabled();
