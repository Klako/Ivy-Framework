...
> **info:** Use `.Min()` and `.Max()` extension methods to set size constraints. Only `Size.Fraction()` is supported for resizeable panels.
...
[View Source: ResizablePanelGroup.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Layouts/ResizablePanelGroup.cs)

### Constructors

| Signature |
|-----------|
| `new ResizablePanelGroup(ResizablePanel[] children)` |
