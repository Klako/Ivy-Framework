...
- **Dependency injection support**: Volumes are registered as [services](./18_Services.md) and can be injected into your [application components](./02_Views.md)
...
<Body>
Access volumes through [dependency injection](./18_Services.md) in your [views](./02_Views.md):
