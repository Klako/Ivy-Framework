...
[View Source: TabsLayout.cs](https://github.com/Ivy-Interactive/Ivy-Framework/blob/main/src/Ivy/Widgets/Layouts/TabsLayout.cs)

### Constructors

| Signature |
|-----------|
| `new TabsLayout(Func<Event<TabsLayout, int>, ValueTask> onSelect, Func<Event<TabsLayout, int>, ValueTask> onClose, Func<Event<TabsLayout, int>, ValueTask> onRefresh, Func<Event<TabsLayout, Int32[]>, ValueTask> onReorder, int? selectedIndex, Tab[] tabs)` |
| `new TabsLayout(Action<Event<TabsLayout, int>> onSelect, Action<Event<TabsLayout, int>> onClose, Action<Event<TabsLayout, int>> onRefresh, Action<Event<TabsLayout, Int32[]>> onReorder, int? selectedIndex, Tab[] tabs)` |
...
| `RemoveParentPadding` | `bool` | `RemoveParentPadding` |
| `SelectedIndex` | `int?` | - |
...
| Name | Type | Handlers |
|------|------|----------|
| `OnAddButtonClick` | `EventHandler<Event<TabsLayout, int>>` | - |
| `OnClose` | `EventHandler<Event<TabsLayout, int>>` | - |
| `OnRefresh` | `EventHandler<Event<TabsLayout, int>>` | - |
| `OnReorder` | `EventHandler<Event<TabsLayout, Int32[]>>` | - |
| `OnSelect` | `EventHandler<Event<TabsLayout, int>>` | - |